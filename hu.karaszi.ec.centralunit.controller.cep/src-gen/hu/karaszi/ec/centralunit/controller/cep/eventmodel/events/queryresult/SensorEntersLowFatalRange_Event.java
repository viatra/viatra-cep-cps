...
public class SensorEntersLowFatalRange_Event extends ParameterizableIncQueryPatternEventInstance {
  private long id;
  
  public SensorEntersLowFatalRange_Event(final EventSource eventSource) {
    super(eventSource);
