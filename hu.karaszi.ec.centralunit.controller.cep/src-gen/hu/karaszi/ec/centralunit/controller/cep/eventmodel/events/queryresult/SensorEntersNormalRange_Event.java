...
public class SensorEntersNormalRange_Event extends ParameterizableIncQueryPatternEventInstance {
  private long id;
  
  public SensorEntersNormalRange_Event(final EventSource eventSource) {
    super(eventSource);
