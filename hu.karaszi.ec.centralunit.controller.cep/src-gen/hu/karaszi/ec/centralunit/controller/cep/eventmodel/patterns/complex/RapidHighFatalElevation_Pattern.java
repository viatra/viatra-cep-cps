...
public class RapidHighFatalElevation_Pattern extends ParameterizableComplexEventPattern {
  public RapidHighFatalElevation_Pattern() {
    super();
    ...
    setId("hu.karaszi.ec.centralunit.controller.cep.eventmodel.patterns.complex.rapidhighfatalelevation_pattern");
  }
}
