...
public class SensorEntersHighFatalRange_Event extends ParameterizableIncQueryPatternEventInstance {
  private long id;
  
  public SensorEntersHighFatalRange_Event(final EventSource eventSource) {
    super(eventSource);
