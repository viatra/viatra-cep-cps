...
public class SensorEntersLowCriticalRange_Event extends ParameterizableIncQueryPatternEventInstance {
  private long id;
  
  public SensorEntersLowCriticalRange_Event(final EventSource eventSource) {
    super(eventSource);
